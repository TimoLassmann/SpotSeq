...
* Introduction 
  ...
  4) generate AUC scores using the R supercite:team-2018-r script =makeROC.R=
...
** Check for SpotSeq installation
   ...
   #+BEGIN_SRC sh -n :tangle check_for_programs.sh :shebang #!/usr/bin/env sh
     programs=(spotseq_model spotseq_score tfbs_bench)
...
#+BEGIN_SRC sh -n :tangle tangleorgs.sh :tangle-mode (identity #o700) :shebang #!/usr/bin/env sh
#
