...
* Run wims model
  ...
  #+BEGIN_SRC bash -n :tangle run_wims_model.sh :shebang #!/usr/bin/env bash :noweb yes
    ...
    echo "find $OUTDIR -name train_*.fa | parallel --jobs $JOBS \"wims_model -i {} -o {}.h5 --nthreads 8 --niter 10000 --seed $SEED\"";
    find $OUTDIR -name "train_*.fa" | parallel --jobs $JOBS "wims_model -i {} -o {}.h5 --nthreads 8 --niter 10000  --seed $SEED"
