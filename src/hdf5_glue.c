...
int hdf5_create_file(char* filename,struct hdf5_data* hdf5_data)
{
	 ...
	 */
	if((hdf5_data->file = H5Fcreate(hdf5_data->file_name, H5F_ACC_TRUNC, H5P_DEFAULT, hdf5_data->fapl)) < 0)  ERROR_MSG("H5Fcreate failed\n");
...
int hdf5_write_1D_char(char* dataset_name, char* data,struct hdf5_data* hdf5_data)
{
	...
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_CHAR, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0])) < 0) ERROR_MSG("H5Dwrite failed");
...
int hdf5_write_1D_int(char* dataset_name, int* data,struct hdf5_data* hdf5_data)
{
	...
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0])) < 0) ERROR_MSG("H5Dwrite failed");
...
int hdf5_write_1D_ushortint(char* dataset_name,unsigned short int* data,struct hdf5_data* hdf5_data)
{
	...
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_USHORT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0])) < 0) ERROR_MSG("H5Dwrite failed");
...
int hdf5_write_1D_float(char* dataset_name, float* data,struct hdf5_data* hdf5_data)
{
	...
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0])) < 0) ERROR_MSG("H5Dwrite failed");
...
int hdf5_write_1D_double(char* dataset_name, double* data,struct hdf5_data* hdf5_data)
{
	...
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_DOUBLE, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0])) < 0) ERROR_MSG("H5Dwrite failed");
...
int hdf5_write_2D_char(char* dataset_name, char** data,struct hdf5_data* hdf5_data)
{
	...
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_CHAR, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0][0])) < 0) ERROR_MSG("H5Dwrite failed");
...
int hdf5_write_2D_int(char* dataset_name,int** data,struct hdf5_data* hdf5_data)
{
	...
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0][0])) < 0) ERROR_MSG("H5Dwrite failed");
	hdf5_close_dataset(hdf5_data);
	return OK;
ERROR:
	return FAIL;
...
int hdf5_write_2D_float(char* dataset_name,float** data,struct hdf5_data* hdf5_data)
{
	...
	//hdf5_create_dataset(dataset_name,hdf5_data, native_type);
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0][0])) < 0) ERROR_MSG("H5Dwrite failed");
	hdf5_close_dataset(hdf5_data);
	return OK;
ERROR:
	return FAIL;
...
int hdf5_write_3D_float(char* dataset_name,float*** data,struct hdf5_data* hdf5_data)
{
	...
	//hdf5_create_dataset(dataset_name,hdf5_data, native_type);
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0][0][0])) < 0) ERROR_MSG("H5Dwrite failed");
	hdf5_close_dataset(hdf5_data);
	return OK;
ERROR:
	return FAIL;
 ...
 int hdf5_write_4D_float(char* dataset_name,float**** data,struct hdf5_data* hdf5_data)
{
	...
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0][0][0][0])) < 0) ERROR_MSG("H5Dwrite failed");
	DPRINTF3("Dataset is : %d",hdf5_data->dataset );
	hdf5_close_dataset(hdf5_data);
	return OK;
ERROR:
...
int hdf5_write_2D_double(char* dataset_name, double** data,struct hdf5_data* hdf5_data)
{
	...
	//hdf5_create_dataset(dataset_name,hdf5_data, native_type);
	if((hdf5_data->status  = H5Dwrite(hdf5_data->dataset, H5T_NATIVE_DOUBLE, H5S_ALL, H5S_ALL, H5P_DEFAULT, &data[0][0])) < 0) ERROR_MSG("H5Dwrite failed");
	hdf5_close_dataset(hdf5_data);
	return OK;
ERROR:
	return FAIL;
...
int main (int argc,char * argv[])
{
	...
	hdf5_create_file("libhdf5gluetest.h5",hdf5_data);
...
int expand_test(void)
{
	...
	if(!my_file_exists("libhdf5gluetest_exp.h5")){
		hdf5_create_file("libhdf5gluetest_exp.h5",hdf5_data);
		hdf5_create_group("group2",hdf5_data);
		...
		hdf5_create_dataset_chunked_expandable("EXPand1",hdf5_data, H5T_NATIVE_USHORT);
	}else{
